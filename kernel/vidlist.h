 ...
 *
 * next_moves/12 step 3. A browser, not yet a player: the list shows every
 ...
 * screen with the 120x68 cover -- which says plainly that playback is the
 * next step rather than pretending otherwise.
 *
