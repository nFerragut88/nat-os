/* cyd-os — periodic tick. See timer.c for why CCOMPARE1 is the source. */
#ifndef CYDOS_TIMER_H
#define CYDOS_TIMER_H
 ...
 * the rate is derived by measurement (see UM-CYDOS-008). */
