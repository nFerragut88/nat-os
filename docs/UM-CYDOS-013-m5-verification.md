...
UM-CYDOS-007 §7 names this milestone's principal risk plainly: *"an application
...
- UM-CYDOS-010 §5.2 — arena bounds and the offset-domain check
- UM-CYDOS-009 — the native scheduler underneath all of this
