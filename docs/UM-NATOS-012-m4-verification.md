# UM-NATOS-012 — Milestone 4 Verification Report
...
This is the milestone where nat-os acquires isolation. Everything before it was
...
save processor state (UM-NATOS-009 §6).
...
This is the safe-boundary preemption of UM-NATOS-001 §4.2: a task hosting a VM
...
| `TOUCH` | UM-NATOS-017 §8 | Coordinates, *inward*, filtered by viewport |
