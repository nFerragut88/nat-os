...
ABI. cyd-os is built entirely with **call0**. This report records the evidence
...
at bytecode-instruction boundaries inside the interpreter (UM-CYDOS-001 §4.2),
...
- UM-CYDOS-001 §4 — application isolation model
- UM-CYDOS-005 — full compiler and linker flag list
