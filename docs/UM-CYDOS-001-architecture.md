# UM-CYDOS-001 — System Architecture and Scope
...
cyd-os is an operating system written from scratch for the ESP32-based "Cheap
...
interface — the image header format (UM-CYDOS-002) — so replacing it later is a
...
- UM-CYDOS-003 — Xtensa ABI Selection
