...
The record built in UM-CYDOS-018 now carries it:
...
that UM-CYDOS-018 §2 describes but had never triggered: the old record was
...
loudly — the same move as the boot counter in UM-CYDOS-018 §2.2.
...
- UM-CYDOS-018 §2 — the record this extends, and its version check
